...
var J = {
  ...
  icons: {
      cross: '/static/img/cross.png',
      refresh: '/static/img/refresh.png',
      rotate: '/static/img/rotate.gif',
      spoiler: '/static/img/spoiler.png',
      ban: '/static/img/ban.png',
      multi: '/static/img/multi.png',
      arrow_right: '/static/img/arrow_right.png'
  }
};
